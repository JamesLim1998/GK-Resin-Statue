function CheckPassword() {
  let username = ["james1998", "whoisjo3l", "james"];
  let password = ["1234567", "11223344", "1234567"];
  ...
  for (let i = 0; i < username.length; i++) {
    if (user === username[i] && pass === password[i]) {
      let move = document.getElementById('log');
      let move1 = document.getElementById('success');
